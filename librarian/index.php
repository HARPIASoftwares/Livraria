...
<html>
	...
	<body>
		...
		<legend>Administrador da Biblioteca</legend>
			...
			<div class="icon">
				<input class="l-user" type="text" name="l_user" placeholder="Usuário" required />
			</div>
			
			<div class="icon">
				<input class="l-pass" type="password" name="l_pass" placeholder="Senha" required />
			</div>
			
			<input type="submit" value="Entrar" name="l_login"/>
