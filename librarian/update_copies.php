...
<html>
	<head>
		<title>Atualização de cópias</title>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>Inserir informações</legend>
				...
				<div class="icon">
					<input class="b-isbn" type='text' name='b_isbn' id="b_isbn" placeholder="ISBN do livro" required />
				</div>
					
				<div class="icon">
					<input class="b-copies" type="number" name="b_copies" placeholder="Número de cópias para adicionar" required />
				</div>
						
				<input type="submit" name="b_add" value="Adicionar cópias" />
		</form>
	</body>
