...
<html>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>Digite todas as informações do novo livro:</legend>
				...
				<div class="icon">
					<input class="b-price" type="number" name="b_price" placeholder="Preço" required />
				</div>
				
				<div class="icon">
					<input class="b-copies" type="number" name="b_copies" placeholder="Número de Cópias" required />
				</div>
				
				<br />
				<input class="b-isbn" type="submit" name="b_add" value="Adicionar" />
		</form>
	<body>
	...
	<?php
		if(isset($_POST['b_add']))
		{
			...
			if(mysqli_num_rows($query->get_result()) != 0)
				echo error_with_field("Já há um livro com isso. ISBN", "b_isbn");
			else
			{
